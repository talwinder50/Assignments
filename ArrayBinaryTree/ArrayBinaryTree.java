...
public class ArrayBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
    ...
    public ArrayBinaryTree(T element, ArrayBinaryTree<T> LT, ArrayBinaryTree<T> RT)
    {
    	count = 1;
    	current = 1;
    	tree = (T[]) new Object[DEFAULT_CAPACITY];
    	...
    	int size = (int) (Math.log(DEFAULT_CAPACITY)/Math.log(2));
    	...
    	for(int i=0; i<size; i++)  
    	{
    		...
    		for(int l=0; l < n; l++)
    		{	
    			tree[current] = (T) LT.tree[left_current];
    			if(LT.tree[left_current] != null)
    			{
    				count++;
    			}
    			left_current++;
    		...
    		for(int r=0; r < n; r++)
    		{
    			tree[current] =(T) RT.tree[right_current];
    				if(RT.tree[right_current] != null)
    			{
    				count++;
    			}
    			right_current++;
    ...
    public String toString()
    {
	 ...
	 /**
	 * Returns an iterator over the elements of this binary tree using the
	 ...
	 * 
	 * @param node
	 *            the index of the node used in the traversal
	 * @param tempList
